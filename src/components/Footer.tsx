...
export default function Footer() {
    return (
        <footer className="w-full bg-black py-16 border-t border-[#3a2516] mt-16">
            <div className="container mx-auto max-w-4xl px-4 flex flex-col md:flex-row md:justify-between items-start pt-6">

                {/* Logo and About */}
                <div className="flex flex-col gap-5 w-full md:w-1/3 pr-8 mb-10 md:mb-0">
                    <img src="/Images/Logo.png" alt="Modern Grain Studios" className="w-32 opacity-90" />
                    <p className="text-sm leading-relaxed text-[#81531e] mt-2">
                ...
                <div className="w-full md:w-1/3 pl-8">
                    <div className="border-b border-[#9E6726] mb-6 pb-3">
                        <h3 className="text-xl font-bold text-white">Work Hours</h3>
                    </div>
                    <ul className="space-y-4 text-sm font-medium text-white list-none m-0 p-0">
                        <li className="flex items-start gap-3">
                            <Clock size={20} color="#81531e" className="mt-0.5 shrink-0" />
                            <span className="leading-snug">8 AM - 5 PM , Monday - Saturday</span>
                        </li>
                        <li className="flex items-center gap-3">
                            <Wrench size={20} color="#81531e" className="shrink-0" />
                            <span>24/7 Emergency Support</span>
                        </li>
                        <li className="mt-8 pt-2">
